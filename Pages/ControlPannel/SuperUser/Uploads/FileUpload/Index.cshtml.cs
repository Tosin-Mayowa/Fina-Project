...
namespace WebApplication2.Pages.ControlPannel.SuperUser.Uploads.FileUpload
{
    public class IndexModel : PageModel
    {
        public bool Is_Done=true;
        public int Num { get; set; }
        private readonly Repository.InterfaceUpload _loanupload;
        private IConfiguration _configuration;
        private IWebHostEnvironment _webHostEnvironment;
        public ICollection<LoanUpload1> LoanUploadFields { get; set; }
        private readonly ApplicationDbContext _db;
        private readonly WebApplication2.Data.ApplicationDbContext _context;

        public IndexModel(WebApplication2.Repository.InterfaceUpload loanupload, IConfiguration configuration, Data.ApplicationDbContext context, ApplicationDbContext db)
        {
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile formFile)
        {
            ...
            if (Num != 0)
            {
                await _db.Database.ExecuteSqlRawAsync("TRUNCATE TABLE LoanUploads1");
                ...
                using (SqlConnection scon = new SqlConnection(sqlconn))
                {
                    ...
                    using (var commd = new SqlCommand("Select count(*) from LoanUploads1", scon))
                    {
