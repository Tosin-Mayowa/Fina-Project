...
{
    public class CouponUploads : InterfaceCoupons
    {
        private IConfiguration _configuration;
        private IWebHostEnvironment _webHostEnvironment;

        public CouponUploads(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string DocumentUpload(IFormFile formFile)
        {
            ...
            string dest_path = Path.Combine(uploadPath, "upload_doc_coupon");
        ...
        public void ImportLoan(DataTable loanupload)
        {
...

            {
...

                {
                    ...
                    sqlBulkCopy.DestinationTableName = "CouponUploads";
