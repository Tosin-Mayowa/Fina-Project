...
{
    public class LoanUploadTwo: InterfaceLoanTwo
    {
        private IConfiguration _configuration;
        private IWebHostEnvironment _webHostEnvironment;

        public LoanUploadTwo(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public void ImportLoan(DataTable loanupload)
        {
...

            {
...

                {
                    ...
                    sqlBulkCopy.DestinationTableName = "LoanUpload2";
