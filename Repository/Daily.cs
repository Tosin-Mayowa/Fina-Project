...
{
    public class Daily: InterfaceDaily
    {
        private IConfiguration _configuration;
        private IWebHostEnvironment _webHostEnvironment;

        public Daily(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string DocumentUpload(IFormFile formFile)
        {
            ...
            string dest_path = Path.Combine(uploadPath, "upload_doc_daily");
        ...
        public void ImportLoan(DataTable loanupload)
        {
...

            {
...

                {
                    ...
                    sqlBulkCopy.DestinationTableName = "U_Daily";
