...
{
    public class CashFlow: InterfaceCashflows
    {
        private IConfiguration _configuration;
        private IWebHostEnvironment _webHostEnvironment;

        public CashFlow(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string DocumentUpload(IFormFile formFile)
        {
            ...
            string dest_path = Path.Combine(uploadPath, "upload_doc_cashflow");
        ...
        sqlBulkCopy.DestinationTableName = "CashFlows";
