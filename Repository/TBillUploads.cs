...
{
    public class TBillUploads : InterfaceTBill
    {
        private IConfiguration _configuration;
        private IWebHostEnvironment _webHostEnvironment;

        public TBillUploads(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string DocumentUpload(IFormFile formFile)
        {
            ...
            string dest_path = Path.Combine(uploadPath, "upload_doc_TBill");
        ...
        public void ImportLoan(DataTable loanupload)
        {
...

            {
...

                {
                    ...
                    sqlBulkCopy.DestinationTableName = "TBills";
